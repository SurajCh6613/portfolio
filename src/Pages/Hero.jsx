  ...
  return (
    <section className="bg-gradient-to-l from-gray-600 to-gray-400  pt-20 w-full h-full flex flex-col-reverse md:flex-row py-3 px-2">
      <div className="w-full md:w-2/3 h-full pl-2 pt-4">
        ...
        <p className="text-md md:text-2xl text-shadow-gray-950 mb-6 md:pr-6">
        ...
        <p className="text-gray-900 md:text-xl mb-6">
      ...
      <div className="w-full md:w-1/3">
        <div className="flex justify-center items-center">
          <img src={heroImage} alt="" className=" w-[12rem] h-[15rem] sm:w-[18rem] sm:h-[20rem] md:w-[26rem] md:h-[30rem]" />
        </div>
      </div>
    </section>
  );
